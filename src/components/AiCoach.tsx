...
interface AiCoachProps {
  ...
  mindsetEntries: MindsetJournalEntry[];
}

const AiCoach: React.FC<AiCoachProps> = ({ crashGames, mindsetEntries }) => {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ mt: 4 }}>
        <Typography variant="h6" gutterBottom sx={{ fontWeight: '600' }}>Performance by Mindset</Typography>
        <MindsetChart crashGames={crashGames} />
      </Box>
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 4 }}>
        <Typography variant="h6" gutterBottom sx={{ fontWeight: '600' }}>Insights</Typography>
